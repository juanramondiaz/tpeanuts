...
\input{chapters/00_introduccion}

% =============================================================================
\part{Propagation Core --- \texttt{core/}}
\input{chapters/01_core_common}
\input{chapters/02_core_sm}
\input{chapters/03_core_bsm}
\input{chapters/04_core_numerical}
\input{chapters/05_core_perturbative}

% =============================================================================
\part{Physical Propagation Media --- \texttt{medium/}}
\input{chapters/06_medium_vacuum}
\input{chapters/07_medium_solar}
\input{chapters/08_medium_earth}
\input{chapters/09_medium_atmosphere}

% =============================================================================
\part{High-Level Pipelines --- \texttt{pipeline/}}
\input{chapters/10_pipeline_solar}
\input{chapters/11_pipeline_earth}
\input{chapters/12_pipeline_solar_earth}
\input{chapters/13_pipeline_atmosphere}
\input{chapters/14_pipeline_atmosphere_earth}

% =============================================================================
\part{Detector Response Layer --- \texttt{detector/}}
\input{chapters/15_detector_common}
\input{chapters/16_detector_interaction}
\input{chapters/17_detector_borexino}

% =============================================================================
% \part{External Engines and Data --- \texttt{external/}}
% \input{chapters/18_external}            % TODO

% =============================================================================
% \part{Infrastructure, Orchestration, and Legacy Code}
% \input{chapters/19_peanuts_legacy}      % TODO
% \input{chapters/20_util}                % TODO
