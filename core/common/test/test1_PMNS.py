...
"""
Verbose tests for tpeanuts.core.common.pmns.

Run with:

    pytest core/common/test/test1_PMNS.py -v -s

or directly:

    python core/common/test/test1_PMNS.py

This version prints detailed diagnostics, matrix errors, unitarity
precision, shapes, dtypes, and batch behaviour.
"""
...
def test_pmns_dtype():
    ...
    print("theta12 dtype :", pmns.params.theta12.dtype)
...
def test_zero_angles_identity():
    ...
    I = torch.eye(3, dtype=torch.complex128, device=pmns.device)
...
def run_test1_PMNS_tests(verbose_traceback=False):
    ...
    return run_test_suite(
        tests,
        suite_name="core.common TEST1 PMNS tests",
